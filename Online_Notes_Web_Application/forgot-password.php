...
$time = time();
$status = 'pending';
$sql = "INSERT INTO forgotpassword (`user_id`, `user_key`, `time`, `status`) VALUES ('$user_id', '$key', '$time', '$status')";
$result = mysqli_query($link, $sql);
if(!$result){
...
$message .= "https://yonghengli.me/notes_app/resetpassword.php?user_id=$user_id&key=$key";
