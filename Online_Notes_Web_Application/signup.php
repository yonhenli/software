...
$message .= "https://yonghengli.me/notes_app/activate.php?email=" . urlencode($email) . "&key=$activationKey";
if(mail($email, 'Confirm your Registration', $message)) {
       ...
       Please click on the activation link to activate your account. It might take few minutes. </div>";
}
else {
